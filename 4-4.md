...
This week's work went smoothly except for two related hiccups.

-  I forgot the password for opacuser, so I had to change it.
```
ALTER USER 'opacuser'@'localhost' IDENTIFIED AS 'XXXXXXX'
```

- I forgot that the password for opacuser was being used in the login.php file, so I had to also change it in the file.
...
```
INSERT INTO books (author, title, publisher, copyright) 
VALUES 
('George Orwell', 'Animal Farm', 'Pub1', '2022-06-11'),
('Miguel de Cervantes', 'Don Quixote', 'Pub1', '2019-01-25'),
('Bram Stoker', 'Dracula', 'Pub2', '2017-10-08'),
('Ray Bradbury', 'Fahrenheit 451', 'Pub3', '2015-04-15'),
('Frank Herbert', 'Dune', 'Pub4', '2005-02-5');
```
